...
const user = {
  ...
  imageUrl:
    '../../public/construction_man&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80',
}
          ...
          {({ open }) => (
            <>
              <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div className="flex justify-between h-16 items-right">
                  ...
                  <div className="hidden md:block">
                    <div className="flex items-end ml-4 md:ml-6">
                      ...
                      >
                        ...
                        <NotificationsActiveIcon className="w-6 h-6" aria-hidden="true" />
                      </button>

                      {/* Profile dropdown */}
                      <div class="text-black px-10 w-48">Hello <br/> Hello again</div>
